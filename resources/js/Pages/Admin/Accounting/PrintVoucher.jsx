...
export default function PrintVoucher({ vouchers, perPage }) {
    ...
    // Formats date to Month-Day (e.g., Mar-26)
    ...
    // Formats date to Full format (e.g., March 26, 2026)
    ...
    return (
        <div className="bg-white min-h-screen pb-20 font-serif">
                        ...
                        <div className="voucher-inner">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[7px] leading-tight">
                                            20E 2nd Camarilla St. Brgy. San Roque, Murphy, Cubao, QC<br/>
                            ...
                            <div className="grid grid-cols-2 gap-10 mt-6 text-[8px]">
                                <div className="text-center relative">
                                    <p className="border-b border-black font-bold uppercase pt-3">DENISE JOY F. ANTOLIN</p>
                                    <p className="text-slate-600">Loan Processor/Cashier</p>
                                    {/* 3. Sync: Signature Date Posted */}
            ...
            <div className="fixed bottom-6 right-6 no-print">
                <button onClick={() => window.print()} className="bg-black text-white px-8 py-3 rounded-xl font-bold shadow-2xl">
                    Print Vouchers
                </button>
            </div>
        </div>
