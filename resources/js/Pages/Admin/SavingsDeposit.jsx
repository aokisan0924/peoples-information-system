                            ...
                            rows.map((row) => (
                                <div key={row.memberId} className="p-4 space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Link href={route('admin.savings.member', row.memberId)} className="text-xs font-semibold text-emerald-600 hover:text-emerald-500">View</Link>
                                    </div>
                                    <div className="flex justify-between items-center pt-2 border-t border-slate-50 dark:border-white/5">
                                        <span className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide">Current Balance</span>
                                        <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">{asMoney(row.balance)}</span>
                                    </div>
                                </div>
                            ))
                        )}
