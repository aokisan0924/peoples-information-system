                ...
                >
                    ...
                    <div className="flex flex-col flex-1 overflow-y-auto py-6 px-4 scrollbar-hide">
                        <nav className="space-y-1.5">
                            ...
                            {/* MEMBERS */}
                            {canAccess('members') && (
                                <NavLink name="admin.members.index" label="Manage Members" icon={Users} />
                            )}

                            {/* LOANS */}
                            {canAccess('loans') && (
                                <NavLink name="admin.loans" label="Loan Applications" icon={CreditCard} />
                            )}
                            ...
                            {canAccess('deposits') && (
                                <>
                                    ...
                                    {/* Collapsible Section for Savings */}
                                    <div>
                                        <button
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <span className={`inline-flex h-9 w-9 items-center justify-center rounded-full border text-xs transition-all ${
                                                    depositsOpen
                                                    ? "bg-slate-100 border-slate-200 text-slate-700 dark:bg-white/10 dark:border-white/10 dark:text-white"
                                                    : "bg-white border-slate-200 text-slate-500 dark:bg-white/5 dark:border-white/10 dark:text-slate-400"
                                                }`}>
                                                    <PiggyBank size={16} />
                                                </span>
                            ...
                            {/* LOAN SETTINGS (Super Admin Only) */}
                            {isSuperAdmin && (
                                <NavLink name="admin.loan-settings.index" label="Loan Settings" icon={Bell} />
                            )}
                    ...
                    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-950/55 backdrop-blur-xl px-4 sm:px-6 transition-colors duration-300">
                        <div className="flex items-center gap-4">
                            <button
                                ...
                                className="lg:hidden p-2 -ml-2 text-slate-600 hover:bg-slate-100 rounded-lg dark:text-slate-300 dark:hover:bg-white/5"
                            >
                                <MenuIcon size={24} />
                            </button>
                            
                            <div className="hidden sm:block">
                                <h2 className="text-sm font-semibold text-slate-800 dark:text-white">Admin Dashboard</h2>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            ...
                            <div className="relative" id="admin-profile-menu">
                                <button 
                                    ...
                                    className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-white/10 transition-colors hover:opacity-80"
                                >
                                ...
                                <AnimatePresence>
                                    {isProfileOpen && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 mt-3 w-48 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 shadow-xl overflow-hidden z-50"
                                        >
                                            ...
                                            <div className="p-1">
                                                ...
                                                {/* ADD ADMIN LINK - Only visible for super-admin */}
                                                {isSuperAdmin && (
                                                    <Link 
